    ...
    return (
        <section className="py-24 px-6 min-h-screen">
            ...
            <div className="max-w-6xl mx-auto mb-32">
                ...
                <div className="border border-gray-200 rounded-3xl p-12 bg-gradient-to-br from-purple-50/70 via-white to-white shadow-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            ...
                            {caseData.website && (
                                <a
                                    ...
                                    className="group inline-flex items-center gap-2 text-gray-700 hover:text-purple-600 transition"
                                >
                        ...
                        {/* RIGHT IMAGE */}
                        <div className="relative h-[280px] md:h-[360px] w-full rounded-2xl overflow-hidden shadow-xl">
                            <Image
                                src={caseData.image}
