                ...
                <div className="relative max-w-6xl mx-auto w-full px-6 py-24 md:py-0">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="text-white max-w-none">
                            <h1 className="hero-rise hero-rise--1 font-bold tracking-tight leading-[0.95] mb-6 uppercase text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl">
                            ...
                            <p className="hero-rise hero-rise--2 max-w-sm sm:max-w-md md:max-w-xl text-gray-300 text-xs sm:text-sm md:text-base lg:text-lg mt-4 leading-relaxed md:leading-relaxed">
                            ...
                            <a
                                href="#contact"
                                className="hero-rise hero-rise--3 cta-pulse mt-8 inline-flex group relative items-center gap-2 pr-3 pl-1 py-1 rounded-full border border-white text-xs sm:text-sm overflow-hidden"
                            >
